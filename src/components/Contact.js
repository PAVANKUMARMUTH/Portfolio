    ...
    <div style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ maxWidth: 400, width: "100%", padding: 24, background: "#fff", borderRadius: 8, boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 24, marginTop: 24 }}>
          <a href="mailto:pavankumarmuthyala8686@gmail.com" style={{ color: "#6c2eb7", fontSize: 28 }} title="Email">
            <MdEmail />
          </a>
          <a href="https://www.linkedin.com/in/pavankumarmuthyala" style={{ color: "#6c2eb7", fontSize: 28 }} target="_blank" rel="noopener noreferrer" title="LinkedIn">
            <FaLinkedinIn />
          </a>
        </div>
      </div>
